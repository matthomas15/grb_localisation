...
def mcmc_sampler(ra, dec, steps, nwalk, move, t_obs, f_obs, t_90, Ph_obs, sat_pos, sat_pointing, flux_limit, offset, lat_lon):
    """
    ...
    sampler = emcee.EnsembleSampler(
        nwalkers, ndim, likelihood.log_probability, args=( ra, t_obs, f_obs, t_90, Ph_obs, sat_pos, sat_pointing, flux_limit, offset,lat_lon),
...
def run_mcmc(ra, dec, flux_avg, t_90, t_obs, f_obs, Ph_obs, sat_pos, sat_pointing, flux_limit, offset,lat_lon, steps, nwalk, move, discard, save_path, corner_show= False, corner_save = False, chain_show= False, chain_save = False):
    """
    ...
    sampler = mcmc_sampler(ra, dec, steps, nwalk, move,  t_obs, f_obs, t_90, Ph_obs, sat_pos, sat_pointing, flux_limit, offset,lat_lon)
